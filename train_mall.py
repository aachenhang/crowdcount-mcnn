...
train_path = './data/formatted_trainval/Mall_patches_9/train'
train_gt_path = './data/formatted_trainval/Mall_patches_9/train_den'
val_path = './data/formatted_trainval/Mall_patches_9/val'
val_gt_path = './data/formatted_trainval/Mall_patches_9/val_den'
